...
const SERVICES = [
  {
    ...
    title: "Gofroquti ishlab chiqarish",
    desc: "3 va 5 qatlamli gofrokartondan standart hamda nostandart o'lchamdagi qutilar. Tashish, saqlash va mahsulot xavfsizligini ta'minlovchi konstruksiyalar.",
    badge: "Asosiy yo'nalish",
  },
  {
    icon: <Sparkles className="w-5 h-5 text-[#C6893F]" />,
    title: "Premium oq qadoqlash (OqLayner)",
    desc: "Tashqi qatlami oq liner bilan qoplangan premium qutilar. Yuqori aniqlikdagi flekso-bosma bilan brending va vizual nufuzni oshiradi.",
    badge: "Brending",
  },
  {
    icon: <Layers className="w-5 h-5 text-[#C6893F]" />,
    title: "Shelf Ready Packaging (SRP)",
    desc: "Ombordan to'g'ridan-to'g'ri savdo rastalariga joylashtiriladigan perforatsiyali qutilar. Merchandising vaqtini 50% gacha tejaydi.",
    badge: "Retail yechim",
  },
  {
    icon: <Zap className="w-5 h-5 text-[#C6893F]" />,
    title: "Ekspress partiyalar (48 soat)",
    desc: "Shoshilinch buyurtmalar uchun 50 000 donagacha qutini 2-3 ish kunida tayyorlash va jo'natish xizmati. Takroriy buyurtmalar — 24 soatda.",
    badge: "Tezkor yetkazish",
  },
];

const INDUSTRIES = [
  "Meva va sabzavotlar (eksport)",
  "To'qimachilik va tikuvchilik",
  "Qandolat va oziq-ovqat",
  "Poyabzal va charm mahsulotlari",
  "Salqin ichimliklar va sharbatlar",
  "Qurilish va sanoat mollari",
  "Farmatsevtika va gigiyena",
  "Yetkazib berish (e-commerce)",
];
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-12 sm:py-16">
          <div className="max-w-3xl">
            <span className="text-xs font-bold text-[#C6893F] uppercase tracking-wider block mb-2">
              Xizmatlar va yechimlar
            </span>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-neutral-900 tracking-tight leading-tight mb-4">
              Gofroqadoq xizmatlari
            </h1>
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed font-normal">
              Loyihalashdan tortib tayyor mahsulotni omboringizgacha yetkazib berishgacha bo'lgan to'liq sikl.
              Har bir biznes tarmog'i uchun xarajatni kamaytiruvchi va himoyani oshiruvchi yechimlar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-10 sm:py-14">
        <div className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-black text-[#C6893F] tracking-tight">
            Asosiy xizmat yo'nalishlarimiz
          </h2>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-10 sm:py-14">
          <div className="mb-6">
            <h2 className="text-xl sm:text-2xl font-black text-neutral-900 tracking-tight mb-2">
              Biz xizmat ko'rsatadigan sohalar
            </h2>
            <p className="text-xs sm:text-sm text-slate-500">
              Har bir yo'nalish uchun mahsulot xususiyatiga mos qadoqlash parametrlari
            </p>
          </div>
